...
Once the `conda-forge` channel has been enabled, `docplex` can be installed with:

```
conda install docplex
```

It is possible to list all of the versions of `docplex` available on your platform with:
